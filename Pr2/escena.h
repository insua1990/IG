...
Qcuatro *qcuatro;
ObjetoRevolucion *peon,*peon1,*peon2,*peon3,*peon4,*cilindro,*perfilX,*perfilZ;
...
public:
    ...
    const static int TETRAEDRO = 2;
    const static int QCUATRO = 3;
    const static int BEETHOVEN = 4;
    const static int BIG_DODGE = 5;
    const static int ANT = 6;
    const static int PEON = 7;
    const static int BARRIDO = 8;
